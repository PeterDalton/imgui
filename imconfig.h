...
// Inject conversion to and from Vector[2|4] to Imgui math types
...
#define IM_VEC2_CLASS_EXTRA \
    explicit ImVec2(core::Vector2 const & v); \
    operator core::Vector2() const;

#define IM_VEC4_CLASS_EXTRA \
    explicit ImVec4(core::Vector4 const & v); \
    operator core::Vector4() const;

#include "Core/Util/Assert.h" // So we can get at CORE_VERIFY_CATEGORY.
#define IM_ASSERT(_EXPR) do { CORE_VERIFY_CATEGORY(ECodeCategory::UI, (_EXPR)); } while (0)
